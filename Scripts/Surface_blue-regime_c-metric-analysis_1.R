#--------------------------------------------------------------
# Geometric morphometric analyses and tests for convergence of convergent regimes obtained by running SURFACE
# Travis Park 2018
...
ds <- read.csv("Data/Surface_blue-regime_habitat-type_1.csv")
...
RDC <- as.matrix(array(RDC_df[, 1:2]))

# Select tips that are river dolphins
convtips <- c("Mesoplodon_mirus",
              "Ziphius_cavirostris")
